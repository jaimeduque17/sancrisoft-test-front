...
const AddProduct = () => {
    ...
    const newPostForm = () => (
        <form className="mb-3" onSubmit={clickSubmit}>
            ...
            <div className="form-group">
                <label className="text-muted">Enviar</label>
    ...
    const showSuccess = () => (
        <div className="alert alert-info" style={{ display: createdProduct ? '' : 'none' }}>
            <h2>{`${createdProduct} es creado!`}</h2>
            </div>
    );
    ...
    return (
        <Layout title="Agregar nuevo producto" description={`Hola ${user.name}, listo para agregar un nuevo producto?`}>
            <div className="row">
